...
## **1.3 Machine learning with direct forecasts**
...
The hh-step ahead forecasts are computed in a direct way:
...
-   Very good to capture non-linear relationships, but needs the series to be somehow stationary (*normalization*)

Hence, RNN are **multiple output** tools: one model is able to forecast all the hh-step ahead forecasts in one shot:
...
## **2.3 Visualization: smart graphs**
...
## **4.5 Installing Keras and TensorFlow**
...
## **4.6 Neural Networks and Deep Learning**
...
## **4.7 Single Layer Perceptron**

![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-BBD116C0.png)
...
![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-3E81282F.png)
...
![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-1203E4A5.png)
...
## **4.11 The loss function and backpropagation**
...
A special NN but with a new layer where the output acts as the input in next iterations

In spirit similar to a Markov chain or an *AR(p)*

![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-D3701453.png)

Other view:

![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-4823F5C4.png)
...
![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-C631A19F.png)
...
## **5.4 LSTM: notation III**

-   Imagine we want to forecast the next 24 hours of data, where there is a 168-hours season (weekly)
...
## **5.7 Dropout and Regularization**

A way to deal with overfitting in recurrent layers and improve performance

-   **Regularization:** reduces complexity of the model (network), adding some bias but reducing the variance. It is usually a l1l1 or l2l2 penalization (lasso or ridge)
...
![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-427A2532.png)

Main idea:train one single model for all the considered time series in a given group

Once the model is trained, it can be used to forecast future loads not only for the smart meters considered in the training set but also for new smart meters

The specific LSTM topology is

![](C:/Users/FAL/AppData/Local/RStudio/tmp/paste-6D23C508.png)\
**7.1 Some conclusions**

-   The methodology can outperform competitive univariate forecasting tools for electricity consumption, providing an implementable and scalable approach for massive time series forecasting

-   In particular, it may provide near real-time forecast for hundreds of thousands of smart meters
...
-   For around 100 electricity smart-meters, the LSTM attains promising results respect to competitive benchmarks, around 20% better performance
